...
builder.Services.AddScoped<ICoD4xAdminReconciliationService, CoD4xAdminReconciliationService>();
builder.Services.AddScoped<ICoD4xCommandPowerReconciliationService, CoD4xCommandPowerReconciliationService>();
...
app.Logger.LogInformation("SFTP host key fingerprint verification is enforced. Servers without fingerprint configuration are skipped.");
